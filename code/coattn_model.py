...
from modules import RNNEncoder, SimpleSoftmaxLayer, BasicAttn, MulAttn, CoAttn
...
class QAModel(object):
    ...
    def build_graph(self):
        ...
        attn_layer = CoAttn(self.keep_prob, self.FLAGS.hidden_size, self.FLAGS.hidden_size * 2)
