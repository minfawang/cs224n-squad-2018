...
class QAModel(object):
    ...
    def build_graph(self):
        ...
        gru_layer1 = RNNEncoder(self.FLAGS.hidden_size, self.keep_prob)  # params: (hidden_size*2 + hidden_size) * hidden_size * 2 * 3
        model_reps = gru_layer1.build_graph(bidaf_out, self.context_mask, variable_scope='ModelGRU1')  # (batch_size, context_len, hidden_size*2)
