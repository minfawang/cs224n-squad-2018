...
from data_batcher import padded, Batch, token_to_padded_character_ids
...
def refill_batches(batches, word2id, char2id, qn_uuid_data, context_token_data, 
                   qn_token_data, batch_size, context_len, question_len, word_len):
    """
...
def get_batch_generator(word2id, char2id, qn_uuid_data, context_token_data, 
    ...
    Inputs:
      ...
      char2id: discionary mapping char to char id
      qn_uuid_data: list of strings that are unique ids
      context_token_data, qn_token_data: list of lists of strings (no UNKs, no padding)
      batch_size: int. size of batches to make
      context_len, question_len: ints. max sizes of context and question. Anything longer is truncated.
      word_len: int. max size of single word.
    ...
    while True:
        ...
        batch = Batch(context_ids, context_mask, context_tokens, qn_ids, qn_mask, 
                      qn_tokens=None, ans_span=None, ans_tokens=None, uuids=uuids,
                      context_char_ids=context_char_ids, qn_char_ids=qn_char_ids)
